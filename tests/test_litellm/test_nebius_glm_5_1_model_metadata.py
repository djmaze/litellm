...
@pytest.mark.parametrize("model", ["nebius/zai-org/GLM-5.1"])
def test_nebius_glm_5_1_model_info(model):
    ...
    assert info["litellm_provider"] == "nebius"
...
def test_nebius_glm_5_1_backup_matches_main():
    ...
    for model in ("nebius/zai-org/GLM-5.1",):
